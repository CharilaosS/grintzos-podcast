...
OTHER_SPEAKERS = re.compile(
    ...
    r"|κατα ιωανν"                     # κατά Ἰωάννην εὐαγγέλιον series (excluded on request)
)
...
def main():
    ...
    out = [
        ...
        "<channel>",
        "<title>π. Ιωάννης Γρίντζος — Ομιλίες</title>",
        f"<link>{BASE}/audio/</link>",
        f'<atom:link href="{FEED_URL}" rel="self" type="application/rss+xml"/>',
        "<language>el</language>",
        "<description>Ομιλίες του π. Ιωάννου Γρίντζου, όπως αναρτώνται στην ιστοσελίδα του Ιερού Ησυχαστηρίου Αγίας Τριάδος Πανοράματος Θεσσαλονίκης. Ανεπίσημο feed· τα αρχεία παίζουν απευθείας από την ιστοσελίδα.</description>",
        "<itunes:author>π. Ιωάννης Γρίντζος</itunes:author>",
